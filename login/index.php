...
<body>
	<div class="container">
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="text-center"><a href="http://isciir.org/"><img src="isciir_black.png"></a></div><br>
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">In order to view the registered members, you need to sign in below</h3>
				</div>
